                            ...
                            <form class="form" method="get" action="">
                                <div class="row">
                                    ...
                                    <div class="col-2 text-end me-0 pe-0">
                                        <button type="submit" class="btn btn-info mb-1 btn-block">Search</button>
                                    </div>
                                    <div class="col-2 pe-0 justify-content-end">
                                        <button type="button" onclick="preview_lavel('qrcode')" class="btn btn-info me-1 mb-1 btn-block"> <i class="bi bi-qr-code"></i> QRCode</button>
                                    </div>
                                    <div class="col-2 pe-0 justify-content-end">
                                        <button type="button" onclick="preview_lavel('barcode')" class="btn btn-info me-1 mb-1 btn-block"><i class="bi bi-upc"></i> Barcode</button>
                                    </div>
                                </div>
                            </form>
                                    ...
                                    <table class="table mb-5">
                                        <thead>
                                            <tr class="bg-primary text-white text-center">
                                                <th class="p-2"><input class="checkall" value="1" type="checkbox"></th>
